defmodule PeusapatWeb.CoreComponents do
  @moduledoc """
  ...
  def header(assigns) do
    ~H"""
    <header class={[@actions != [] && "flex items-center justify-between gap-6 mb-8", @class]}>
      <div class="">
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(PeusapatWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(PeusapatWeb.Gettext, "errors", msg, opts)
    end
  end
